...
<jsp:setProperty property="*" name="obj_Login_Bean"/>
 ...
 <%
 /*System.out.println(obj_Login_Bean.getPrenom());
 System.out.println(obj_Login_Bean.getNom());
 */
 
 Login obj_Login_Modal=new Login();
 ...
 if(flag){
	 ...
	 %>
		<script type="text/javascript">
		    window.location.href="http://localhost:8080/freelance/FreelancerHome.php";
		</script>
		<%	
 }else{
...
%>
		<script type="text/javascript">
		    window.location.href="http://localhost:8080/freelance/login.jsp";
		</script>
