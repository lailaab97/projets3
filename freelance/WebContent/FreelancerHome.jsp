...
<!--===============================================================================================-->
	...
	<div id="page">
		...
		<h2 style="text-align:center;"> Dernieres offres en Freelance</h2>
		<div class="limiter">
						...
						<table>
							<thead>
								<tr class="row100 head">
									<th class="cell100 column1">Projet</th>
									<th class="cell100 column2">Catégorie</th>
									<th class="cell100 column3">Durée</th>
						...
						<table>
							<tbody>
								<tr class="row100 body">
									...
									<td class="cell100 column1">${p.projet}</td>
									<td class="cell100 column2">${p.categorie}</td>
									<td class="cell100 column3">${p.dure}</td>
									<td class="cell100 column4">${p.budget} dhs</td>
									<td class="cell100 column5"><a href="postulation?id=${p.id}"><button type="button"> Postuler</button></a></td>
