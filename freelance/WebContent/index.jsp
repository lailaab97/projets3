					...
					<div class="row">
						...
						<div class="col-md-10 text-right menu-1">
							<ul>
								...
								<li class="btn-cta"><a href="login.jsp"><span>SE CONNECTER</span></a></li>
							</ul>
						</div>
					</div>
				</div>
            ...
            <div class="card card-5">
                ...
                <div class="card-body">
                    <form action="controleur.php" method="POST">
                                ...
                                <div class="row row-space">
                                    <div class="col-2">
                                        <div class="input-group-desc">
                                            <input class="input--style-5" type="text" name="prenom" value="${odel.freelancer.prenom}">
                                            <label class="label--desc">Prenom</label>
                                        </div>
                                    </div>
                                    <div class="col-2">
                                        <div class="input-group-desc">
                                            <input class="input--style-5" type="text" name="nom" value="${odel.freelancer.nom}">
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text" name="adresse" value="${odel.freelancer.adresse}">
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text" name="mail" value="${odel.freelancer.mail}">
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text" name="mdp" value="${odel.freelancer.mdp}">
                                </div>
                            </div>
                        </div>
                        <div class="form-row m-b-55">
                            ...
                            <div class="value">
                                <div class="row row-refine">
                                    ...
                                    <div class="col-9">
                                        <div class="input-group-desc">
                                            <input class="input--style-5" type="text" name="tel" value="${odel.freelancer.tel}">
                        ...
                        <div>
                            <button class="btn btn--radius-2 btn--red" name="action" type="submit" value="save" >Enregitrer</button>
                        </div>
                    </form>
                </div>
            </div>
